...
/* harmony import */ var _modules_regulars_phoneMask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/regulars/phoneMask */ "./src/js/modules/regulars/phoneMask.js");
/* harmony import */ var _modules_regulars_checkMailInputs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/regulars/checkMailInputs */ "./src/js/modules/regulars/checkMailInputs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var pageOneSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    container: '.page'
  });
  pageOneSlider.render();
  var pageTwoSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    container: '.moduleapp',
    prev: '.prevmodule',
    next: '.nextmodule'
  ...
  var shoupSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  new _modules_regulars_phoneMask__WEBPACK_IMPORTED_MODULE_5__["default"]('[name="phone"]').init();
  new _modules_regulars_checkMailInputs__WEBPACK_IMPORTED_MODULE_6__["default"]().init();
});
...
/*#__PURE__*/
function () {
  function Diference(column, items) {
  ...
  _createClass(Diference, [{
    ...
    value: function bindtriggers() {
      ...
      this.column.querySelector('.plus').addEventListener('click', function () {
        if (_this.counter < _this.itemsColumn.length - 2) {
          _this.itemsColumn[_this.counter].style.display = '';
          _this.counter++;
        } else {
          _this.itemsColumn[_this.counter].style.display = '';

          _this.column.querySelector('.plus').closest('.officer__card-item').remove();
        }
      });
    }
  }, {
    ...
    value: function hideItems() {
      this.itemsColumn.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          statusMessege.textContent = _this.messege.loading;
          var formData = new FormData(form);

          _this.postData(_this.path, formData).then(function (res) {
            statusMessege.textContent = _this.messege.success;
            console.log(res);
          }).catch(function () {
            statusMessege.textContent = _this.messege.failure;
          }).finally(function () {
            _this.clearInputs();
...
/***/ "./src/js/modules/regulars/checkMailInputs.js":
/*!****************************************************!*\
  !*** ./src/js/modules/regulars/checkMailInputs.js ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/regulars/phoneMask.js":
/*!**********************************************!*\
  !*** ./src/js/modules/regulars/phoneMask.js ***!
  \**********************************************/
/*! exports provided: default */
...
function () {
  ...
  _createClass(PhoneMask, [{
    ...
    value: function init() {
      ...
      var inputs = document.querySelectorAll(this.select);
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      var commonInitCounter = function commonInitCounter() {
        _this2.checkSlide(_this2.slideIndex += 1);

        _this2.initSlides(_this2.slideIndex);
      };
      ...
      document.querySelectorAll('.sidecontrol > a').forEach(function (btn) {
        btn.addEventListener('click', function () {
          _this2.initSlides(_this2.slideIndex = 1);
        });
      });
    }
  }, {
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, prev, activeClass, animate));

    try {
      if (_this.container.classList.contains('feed__slider')) {
        _this.slides = document.querySelectorAll('.feed__item');
      }
    } catch (e) {}
